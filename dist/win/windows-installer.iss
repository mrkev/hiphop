...
; Don't ask for a install folder (it goes into \Users\Username\AppData\Roaming\HipHop\, which doesn't require admin privileges)
UsePreviousAppDir=no
DefaultDirName={userappdata}\HipHop
DisableDirPage=yes
...
SetupIconFile=..\..\images\hiphop.ico
OutputDir=.\
...
Name: "{app}\{#AppName}"; WorkingDir: "{app}"; Filename: "{app}\node-webkit\nw.exe"; Parameters:"""{app}\app"""; IconFilename: "{app}\app\images\hiphop.ico"; Flags: runminimized preventpinning
; Another in the group (this one can be featured)
Name: "{group}\{#AppName}"; WorkingDir: "{app}"; Filename: "{app}\node-webkit\nw.exe"; Parameters:"""{app}\app"""; IconFilename: "{app}\app\images\hiphop.ico"; Flags: runminimized
